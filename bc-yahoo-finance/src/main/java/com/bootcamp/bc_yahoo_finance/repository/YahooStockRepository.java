...
@Query(value = "SELECT * FROM TSTOCK_QUOTE_YAHOO WHERE symbol = :symbol AND market_time BETWEEN :marketTime AND :marketTimeMax ORDER BY market_time DESC", nativeQuery = true)
